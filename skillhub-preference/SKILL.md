...
5. For skills that include `package.json`, `skillhub-canonical` should auto-install dependencies after install/upgrade, while keeping `node_modules` out of Git.
6. Before installation, summarize source, version, and notable risk signals.
